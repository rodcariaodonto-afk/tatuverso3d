...
export const Route = createFileRoute("/admin/config")({
  head: () => ({ meta: [{ title: "Configurações — Admin Café EX" }] }),
...
const STORE_FIELDS = [
  { key: "store.name", label: "Nome da loja", placeholder: "Café EX" },
...
const COMPANY_FIELDS = [
  { key: "company.legal_name", label: "Razão social", placeholder: "Café EX LTDA" },
    ...
    <div className="space-y-6">
      <div className="rounded-lg border border-border bg-card p-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Escolha quais formas de pagamento serão oferecidas no checkout da Café EX.
        </p>
