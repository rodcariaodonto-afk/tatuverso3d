...
export const Route = createFileRoute("/termos")({
  head: () => ({ meta: [{ title: "Termos de uso — Cafezeira" }] }),
  component: () => (
    <div className="container mx-auto max-w-3xl px-4 py-16 md:px-6">
      ...
      <div className="prose mt-8 max-w-none space-y-4 text-sm leading-relaxed text-foreground/85">
        <p>
          Bem-vindo à Cafezeira. Ao usar nossa plataforma, você concorda com estes termos. Somos um
          marketplace que conecta produtores de café especial a consumidores.
        </p>
        <p>
          Os pedidos são processados via produtores parceiros e a Cafezeira atua como intermediadora,
