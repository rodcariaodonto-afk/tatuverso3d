...
export const Route = createFileRoute("/private-label")({
  head: () => ({
    meta: [
      { title: "Café com sua marca · Private Label — Cafezeira" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Private Label Cafezeira — Café com sua marca" },
      {
      ...
      <section className="container mx-auto px-4 py-20 md:px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-muted-foreground">
            Empresas que escolheram a Cafezeira para criar cafés corporativos com identidade própria.
          </p>
        </div>
