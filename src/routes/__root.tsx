...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cafezeira" },
      { name: "description", content: "Cafezeira Platform is a web application for managing and evaluating coffee-related data." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Cafezeira" },
      { property: "og:description", content: "Cafezeira Platform is a web application for managing and evaluating coffee-related data." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Cafezeira" },
      { name: "twitter:description", content: "Cafezeira Platform is a web application for managing and evaluating coffee-related data." },
