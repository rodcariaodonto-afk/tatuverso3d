...
export const Route = createFileRoute("/sobre")({
  head: () => ({
    meta: [
      { title: "Sobre — TatuVerso3D" },
      { name: "description", content: "A TatuVerso3D é a vitrine digital dos cafés especiais latino-americanos." },
    ],
  }),
  component: AboutPage,
});
...
function AboutPage() {
  return (
    <div className="container mx-auto max-w-3xl px-4 py-16 md:px-6">
      ...
      <h1 className="mt-2 font-display text-4xl text-primary md:text-5xl">A TatuVerso3D</h1>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-foreground/85">
        ...
        <p>
          ...
          Por isso, cada produtor da TatuVerso3D tem nome, rosto e território. E cada cafezeiro tem
